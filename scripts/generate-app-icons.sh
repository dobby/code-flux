...
if command -v iconutil >/dev/null 2>&1; then
  ...
  mkdir -p "$ICONSET_DIR"
  magick "$TMP_DESKTOP_MASTER" -resize 16x16 "PNG32:$ICONSET_DIR/icon_16x16.png"
  magick "$TMP_DESKTOP_MASTER" -resize 32x32 "PNG32:$ICONSET_DIR/icon_16x16@2x.png"
  magick "$TMP_DESKTOP_MASTER" -resize 32x32 "PNG32:$ICONSET_DIR/icon_32x32.png"
  magick "$TMP_DESKTOP_MASTER" -resize 64x64 "PNG32:$ICONSET_DIR/icon_32x32@2x.png"
  magick "$TMP_DESKTOP_MASTER" -resize 128x128 "PNG32:$ICONSET_DIR/icon_128x128.png"
  magick "$TMP_DESKTOP_MASTER" -resize 256x256 "PNG32:$ICONSET_DIR/icon_128x128@2x.png"
  magick "$TMP_DESKTOP_MASTER" -resize 256x256 "PNG32:$ICONSET_DIR/icon_256x256.png"
