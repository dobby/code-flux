...
- Name: frontend/tests/e2e/dashboard.spec.ts >> v2 workspace >> route smoke checks for v2 states
- Location: frontend/tests/e2e/dashboard.spec.ts:208:3
...
Call log:
  - navigating to "/activity", waiting until "load"
