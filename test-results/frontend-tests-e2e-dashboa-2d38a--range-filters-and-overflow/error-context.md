...
- Name: frontend/tests/e2e/dashboard.spec.ts >> v2 workspace >> customer pages use shared header controls for time range, filters, and overflow
- Location: frontend/tests/e2e/dashboard.spec.ts:56:3
